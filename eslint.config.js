...
export default tseslint.config(
  {
    ignores: ["node_modules", "pnpm-lock.yaml", "eslint.config.js", "dist"],
  },
  ...
  eslintPluginUnicorn.configs.recommended,
  {
    ...
    languageOptions: {
      parserOptions: {
        ...
        // Share a single TS program to reduce memory
        projectService: true,
        // Allow JS/JSON config files to be linted without being in the TS project
        allowDefaultProject: ["**/*.js", "**/*.cjs", "**/*.mjs", "**/*.json"],
